...
Test(attribute_dist_min, same) {
    ...
    const float val = AttributeCalculate(DIST_MIN, shapelet, 2, series, 2);
...
Test(attribute_dist_min, long) {
    ...
    const float val = AttributeCalculate(DIST_MIN, shapelet, 2, series, 4);
...
Test(attribute_dist_max, same) {
    ...
    const float val = AttributeCalculate(DIST_MAX, shapelet, 2, series, 2);
...
Test(attribute_dist_max, long) {
    ...
    const float val = AttributeCalculate(DIST_MAX, shapelet, 2, series, 4);
